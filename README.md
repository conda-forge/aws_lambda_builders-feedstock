About aws_lambda_builders-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/aws_lambda_builders-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aws_lambda_builders-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add aws_lambda_builders
# for installing globally
pixi global install aws_lambda_builders
```
...
It is possible to list all of the versions of `aws_lambda_builders` available on your platform:
...
```
pixi search aws_lambda_builders --channel conda-forge
```
